...
class ChallengeFirstYearAdapter(private val isBlur: Boolean, private val viewModel: ChallengeHomeViewModel, private val navigator: BaseNavigator): RecyclerView.Adapter<ChallengeFirstYearAdapter.ItemViewHolder>() {
