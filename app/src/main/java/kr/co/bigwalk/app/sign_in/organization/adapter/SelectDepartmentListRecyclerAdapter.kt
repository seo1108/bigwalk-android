...
class SelectDepartmentListRecyclerAdapter(private val navigator: BaseNavigator) : RecyclerView.Adapter<SelectDepartmentListRecyclerAdapter.ItemViewHolder>(), Filterable {

    private var items = listOf<Department>()
    private var searchedItems = listOf<Department>()

    class ItemViewHolder(private val binding: ItemRecyclerSelectDepartmentBinding) :
        ...
        fun bind(department: Department) {
            ...
            itemView.setOnClickListener {
                ...
                intent.putExtra("DepartmentItem", department)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val itemViewHolder = ItemViewHolder(
            DataBindingUtil.inflate(
                ...
                R.layout.item_recycler_select_department,
                parent,
                false
            )
        )
