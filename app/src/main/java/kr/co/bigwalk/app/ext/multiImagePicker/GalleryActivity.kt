package kr.co.bigwalk.app.ext.multiImagePicker
...
import kr.co.bigwalk.app.databinding.ActivityGalleryBinding
import kr.co.bigwalk.app.ext.multiImagePicker.adapter.ImagesAdapter
import kr.co.bigwalk.app.ext.multiImagePicker.model.ImageModel
...
class GalleryActivity : AppCompatActivity() {
    ...
    private fun initToolbar() {
        ...
        binding.layoutToolbar.toolbar.apply {
            ...
            binding.layoutToolbar.title.text = getString(R.string.select_photos)
            setSupportActionBar(this)
            supportActionBar?.setDisplayHomeAsUpEnabled(true)
            setNavigationIcon(R.drawable.aos_icon_20_arrow)
    ...
    private fun updateFAButtonAndTitle() {
        ...
        if(selectedImages > 0){
            ...
            binding.layoutToolbar.title.text = getString(R.string.title_image_selected).format(selectedImages)
        }
        else{
