...
import kr.co.bigwalk.app.databinding.FrameTodayRankingBinding
import java.util.*

class TodayRankingFragment: Fragment() {
    companion object {
        fun newInstance() = TodayRankingFragment()
    }
    private lateinit var binding: FrameTodayRankingBinding
    private lateinit var adapter: RankingPlusRecyclerAdapter
    private lateinit var viewModel: TodayRankingViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        viewModel = TodayRankingViewModel(activity as RankingPlusActivity)
    ...
    override fun onCreateView(
        ...
        FirebaseAnalytics.getInstance(requireActivity()).logEvent("ranking_today_view", Bundle())
        binding = DataBindingUtil.inflate(inflater, R.layout.frame_today_ranking, container, false)
    ...
    override fun onDestroyView() {
        ...
        viewModel.manageTodayRankNumber(Calendar.getInstance())
    }
    ...
    private fun updateView() {
        ...
        binding.appBar.addOnOffsetChangedListener(AppBarLayout.OnOffsetChangedListener { appBarLayout, verticalOffset ->
            ...
            if (viewModel.areOnSeason.value == true) {
                ...
                binding.reportPagerIndicator.visibility = if (isCollapsed) View.GONE else View.VISIBLE
            }
        })
    }
}