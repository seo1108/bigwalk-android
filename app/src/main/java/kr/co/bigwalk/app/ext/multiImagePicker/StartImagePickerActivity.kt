...
import kr.co.bigwalk.app.feed.FeedPhotoSelectFragment
...
class StartImagePickerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = DonationStepMissionViewModel(this, DonationData(FeedPhotoSelectFragment.campaignId))
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_PICK_IMAGE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                val imageListInUri = result.getImageList()
