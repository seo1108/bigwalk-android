...
class ChallengeThirdYearAdapter(private val isBlur: Boolean, private val viewModel: ChallengeHomeViewModel, private val navigator: BaseNavigator): RecyclerView.Adapter<ChallengeThirdYearAdapter.ItemViewHolder>() {
