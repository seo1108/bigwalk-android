...
class ChallengeYearPagingAdapter(private val isBlur: Boolean, private val viewModel: ChallengeHomeViewModel, private val navigator: BaseNavigator): RecyclerView.Adapter<ChallengeYearPagingAdapter.ItemViewHolder>() {
