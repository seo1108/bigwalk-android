...
class ChallengeSecondYearAdapter(private val isBlur: Boolean, private val viewModel: ChallengeHomeViewModel, private val navigator: BaseNavigator): RecyclerView.Adapter<ChallengeSecondYearAdapter.ItemViewHolder>() {
    ...
    class ItemViewHolder(private val binding: ItemRecyclerChallengeHomeBinding) :
        ...
        fun bind(viewModel: ChallengeHomeViewModel, challengeHomeItem: ChallengeInfoResponse, isBlur: Boolean) {
            ...
            /*if (isBlur) {
                binding.blurText.visibility = View.GONE
                binding.blurScreen.visibility = View.VISIBLE
            }*/
            if (challengeHomeItem.remainDays == null || (challengeHomeItem.remainDays != null && challengeHomeItem.remainDays!! <= 0L)) {
                //binding.blurText.visibility = View.GONE
                binding.blurScreen.visibility = View.VISIBLE
            }
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        holder.bind(viewModel, items[position], isBlur)
    }
